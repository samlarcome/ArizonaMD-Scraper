...
def getURLS(url):
    ...
    # with open('./providerLinks.json', 'w', encoding='utf-8') as f:
    #     json.dump(jsondump, f, ensure_ascii=False, indent=4)

    return jsondump

if __name__ == "__main__":
    getURLS(url = "https://azbomprod.azmd.gov/GLSuiteWeb/Clients/AZBOM/public/WebVerificationSearch.aspx?q=azmd&t=20220622082816")
